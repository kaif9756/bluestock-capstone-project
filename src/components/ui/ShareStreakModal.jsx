      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            bg-white p-5 sm:p-8 rounded-2xl shadow-xl z-50 
            w-[90%] max-w-sm"
          >
            ...
            <button
              onClick={handleCopy}
              className="w-full bg-primary text-white py-3 rounded-lg flex items-center justify-center gap-2 active:scale-95"
            >
              <Share2 size={18}/>
              Copy Share Text
            </button>
